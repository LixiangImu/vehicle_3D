...
class VehicleDetector3D:
    ...
    def visualize_3d_scene(self, detections):
        ...
        camera_distance = 150  # 增加相机到场景中心的距离
        camera_height = 100   # 增加相机高度
        
        # 设置相机位置和朝向
        camera_pos = np.array([0, camera_height, -camera_distance])  # 修改相机位置，注意Z轴为负值表示在场景前方
        ...
        ctr.set_up(up)
        ctr.set_zoom(0.1)  # 减小zoom值以获得更广的视野
