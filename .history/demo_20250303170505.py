...
class VehicleDetector3D:
    ...
    def visualize_3d_scene(self, detections):
        ...
        # 使用 ScreenCamera_2025-03-03-17-04-00.json 中的实际参数
        front = [-0.99732326458865916, 0.0096422724730843117, 0.072479876460810846]
        lookat = [5.4181469570481262, -6.6101331844313016, 91.664419793546742]
        up = [-0.036299243541993251, -0.9257793033803271, -0.37631774652667593]
        zoom = 0.7  # 这个值可能需要根据实际效果调整
