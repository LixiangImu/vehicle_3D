...
class Visualizer3D:
    ...
    def visualize(self, detections: List[Dict[str, Any]], poses: List[Dict[str, Any]]) -> None:
        ...
        try:
            ...
            # 使用实际窗口尺寸设置内参
            view_control_params = ctr.convert_to_pinhole_camera_parameters()
            actual_width = view_control_params.intrinsic.width
            actual_height = view_control_params.intrinsic.height
