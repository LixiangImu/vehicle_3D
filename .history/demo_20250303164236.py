...
class VehicleDetector3D:
    ...
    def estimate_vehicle_pose(self, front_point, rear_point, bbox):
        ...
        # 将y坐标设置为车辆高度的一半，使车辆落在地面上
        center_3d[1] = self.default_car_height * 0.5
    ...
    def visualize_3d_scene(self, detections):
        ...
        vis.create_window()  # 移除 visible=False，允许窗口显示
        
        # 添加坐标系
        coordinate_frame = o3d.geometry.TriangleMesh.create_coordinate_frame(
            size=5.0, origin=[0, 0, 0])  # 增大坐标系尺寸
        ...
        ctr.set_zoom(0.1)
        ctr.set_front([1, -1, -1])  # 设置相机方向
        ctr.set_lookat([0, 0, 0])   # 设置观察点
